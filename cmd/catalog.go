...
import (
	...
	"github.com/liatrio/skills-oci/pkg/config"
...
// subcommand and loads .skills-oci.yaml (if present) into the command
// context so subcommands have a uniform place to read project-level
// defaults from.
